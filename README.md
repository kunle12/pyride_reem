...
```
roslaunch pyride_reem pyride.launch
```
...
telnet host 27005
```
where ```host``` is the robot/machine PyRIDE is running on. Figure 2 shows the telnet console displays a list of built-in methods available to PyRIDE on REEM.
